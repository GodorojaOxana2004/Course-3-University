...
**3 Трассировка до локального сервера** — если в локальной сети есть сервер, выполнить `traceroute 127.0.0.53` и сохранить.
...
#### 4 SSL-сертификат (действителен ли?)
